...
class ClothingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clothing" do
    assert_difference('Clothing.count') do
      post clothings_url, params: { clothing: { brand: @clothing.brand, category: @clothing.category, gender: @clothing.gender, price: @clothing.price, size: @clothing.size } }
    end
  ...
  test "should update clothing" do
    patch clothing_url(@clothing), params: { clothing: { brand: @clothing.brand, category: @clothing.category, gender: @clothing.gender, price: @clothing.price, size: @clothing.size } }
